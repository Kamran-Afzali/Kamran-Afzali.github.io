...
layout: post
categories: posts
title: Exponential Smoothing and Holt-Winters Models in Stan
featured-image: /images/stan.png
tags: [STAN, Time seires, Bayes]
date-string: August 2026 
---

# **Exponential Smoothing and Holt-Winters Models in Stan**

We have already discussed ARIMA-style models and exponential smoothing
techniques, in this post, we explore how to model these systems in a
Bayesian framework using **Stan** and **RStan**, bringing full
probabilistic inference and uncertainty quantification to these
well-known methods.
...
Simple Exponential Smoothing assumes a local level that evolves
recursively:
...
Bayesian formulations of Exponential Smoothing and Holt-Winters models
offer elegant alternatives to frequentist smoothing, with the advantage
of posterior inference, natural handling of uncertainty, and full
probabilistic forecasting. Using **Stan** via **RStan**, we can model
level, trend, and seasonality in a transparent and interpretable
way—crucial for applications in forecasting and planning. These methods
can be extended further to include hierarchical structure, time-varying
parameters, or non-Gaussian errors for more complex real-world tasks.

------------------------------------------------------------------------

layout: post categories: posts title: Bayesian Exponential Smoothing and
Holt-Winters Models featured-image: /images/stan.png tags: [STAN, Time
series, Bayes, Forecasting] date-string: February 2026 \*\*\*
...
there, natural extensions include damped trends, robust Student-$t$
