Here is your text with **proper Markdown math rendering** by ensuring all **inline math is enclosed in single dollar signs `$...$`** and all **display math in double dollar signs `$$...$$`**:
