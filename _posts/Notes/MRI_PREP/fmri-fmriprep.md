...
fMRIPrep has been tested on images acquired at 1 and 3 Tesla field strength with support for multi-band echo-planar imaging sequences. fMRIPrep autonomously adapts the preprocessing workflow to the input data, affording researchers the possibility to fine-tune their MR protocols to their experimental needs and design.
...
+ [fMRIPrep github nipreps](https://github.com/nipreps/fmriprep)
+ [fMRIPrep github poldracklab](https://github.com/poldracklab/ds003-post-fMRIPrep-analysis)
