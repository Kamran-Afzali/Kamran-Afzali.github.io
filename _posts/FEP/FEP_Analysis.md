...
One article states that from a FEP perspective, dreaming reworks trauma so that it becomes "thinkable".

**Traumatic experiences that induce too much entropy may not be integrated by the generative model of the brain and are cleaved from functioning**.

From the perspective of the FEP, **psychoanalytic therapies involve the transformation of the generative model with the idea that this will induce transformation of the subject’s relationship**. The main components of psychoanalytic therapies favor transformational processes, including specific processes like dreams.
